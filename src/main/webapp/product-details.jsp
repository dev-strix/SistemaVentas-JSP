...
<%
    ...
    System.out.println("ID desde JSP: "+id);
    Producto producto = new ControladorProducto().getProducto(id);
    System.out.println("este el producto: "+producto.getNombre());
%>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<img src="images/product-details/rating.png" alt="" />
                                                                ...
                                                                <!-- aqui va la comunicacion del form con el servlet "agregarproducto" que esta en AddCar.java-->
                                                                <form action="agregarproducto" method="post">
                                                                    <span>
                                                                            <span>US $<%= producto.getPrecio()%></span>
                                                                            <label>Quantity:</label>
                                                                            <!-- la siguiente linea es para enviar el id al
                                                                            submit, pero este no se ver�, solo para el servlet-->
